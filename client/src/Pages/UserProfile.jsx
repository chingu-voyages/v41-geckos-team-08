...
export const UserProfile = () => {
	...
	return (
		<div className="bg-white  rounded-sm border-none">
         ...
         backgroundColor={buttonAClicked ? 'primary-300' : 'primary-100'}
        ...
        />
         ...
         backgroundColor={buttonBClicked ? 'primary-300' : 'primary-100'}
         name={auth.data.is_supplier ? 'Jobs Pending' : 'Jobs In Progress'}
									handleClick={() => {
        ...
        />
						...
						<div className="flex flex-col justify-center items-center py-12 gap-12 ">
							<h1 className="text-xl font-bold mb-5 text-center text-quaternary-300">
								{buttonAClicked ? 
								(auth.data.is_supplier ? 'Jobs Taken' : 'Jobs Posted') : 
