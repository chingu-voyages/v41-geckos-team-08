...
export const ProfileCard = () => {
  ...
  return (
    <div className='w-5/6 h-72 rounded-lg bg-tertiary-100 max-w-2xl max-h-96 text-center m-0 flex flex-col justify-center shadow-customShadow'>
      <div className='p-6'>
        <h5 data-testid='profileName' className='text-primary-100 text-xl font-extrabold mb-2'>
          {auth.data.name}
        </h5>
        <hr className='my-6 mx-auto w-1/2'></hr>
        <p data-testid='profileEmail' className='text-black text-base mb-1'>
          <span className='font-bold'>Email:</span> {auth.data.email}
        </p>
        <p data-testid='profilePhone' className='text-black text-base mb-1'>
          <span className='font-bold'>Phone:</span> {formatPhoneNumber(auth.data.phone)}
        </p>
        <p data-testid='profileType' className='text-primary-100 text-lg mt-2 font-bold -mb-1'>
